...
import sys
# Load the datasets
extracted_notes = pd.read_csv('data/extracted_discharge_notes_hypertension_p1.csv') 
...
- Example 2: "Blood pressure is normal." --> (2) No
...
# Save final results
extracted_notes.to_csv(f"/results/P1/A10_hypertension_llama70_11_{RANDOM_SEED}.csv", index=False)