...
def generate_response(note_text):
    ...
    Task: 
    Classify the use of insulin from patient clinical notes. Respond only with the following numerical codes based on the notes provided:
...
extracted_notes.to_csv(f"/results/P1/A10_insulin_llama70_22_non_{RANDOM_SEED}.csv", index=False)