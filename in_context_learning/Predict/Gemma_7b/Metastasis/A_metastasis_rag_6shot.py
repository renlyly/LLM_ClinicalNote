...
# %%
extracted_notes = pd.read_csv('/results/newrag/filtered_2sen_discharge_notes.csv')
...
if '1.1-' in VARIANT:
    VARIANT2 = VARIANT.replace('1.1-', '')  # check the version of the model
else:
    VARIANT2 = VARIANT  # 
# VARIANT = '7b-it'  # version of model
MACHINE_TYPE = 'cuda:0'
...
extracted_notes.to_csv(f"/results/p2/p1_results_0236x2_few_shot6_{RANDOM_SEED}_new.csv", index=False)
