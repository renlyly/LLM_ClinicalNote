...
csv_file <- file.path(csv_dir, "consolidated_summary_subject_model_sensitivity.csv")
...
output_jpg <- file.path(output_dir, "model_sensitive_3model_private_subject.jpg")
output_pdf <- file.path(output_dir, "model_sensitive_3model_private_subject.pdf")
