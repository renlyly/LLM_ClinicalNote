...
tasks = [
    ...
    (
        ...
        '/results/P1/A01_insulin_11_preprocessed_Regex_p1'
    )
]
...
for input_csv_path, output_base_path in tasks:
    ...
    tmp_progress_csv_path = f"{output_base_path}_progress_temp_{RANDOM_SEED}.csv"
        ...
        if llm_class_val == 'Pending' or llm_class_val == 'nan': 
            ...
            while not matched_classification and generation_attempt_count < 10 and not error_occurred:
                ...
                try:
                    ...
                    #print(f"Generated response for index {index}: {response_text}")
