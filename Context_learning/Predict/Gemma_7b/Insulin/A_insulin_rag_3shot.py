...
#USER_CHAT_TEMPLATE = 'Analyze the following clinical notes to determine if the patient uses insulin:\n{notes}.<end_of_turn>\n'
...
tasks = [
    (
        '/subset_data/filtered_2sen_discharge_notes_insulin.csv',
        '/results/P1/A02_insulin_21_T2_shot_p1'
    )
