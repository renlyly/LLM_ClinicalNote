...
# Load the dataset
extracted_notes = pd.read_csv('/subset_data/filtered_2sen_discharge_notes_hypertension.csv')
...
- Example 4: "He has no history of hypertension, and this is likely secondary to cyclosporine." --> (2)
- Example 5: "She was not hypertensive during her stay." --> (2)
- Example 6: "No pulmonary hypertension or clinically-significant valvular disease seen." --> (2)
- Example 7: "There is borderline pulmonary artery systolic hypertension." --> (3)
- Example 8: "Family History: Significant for breast cancer, high blood pressure."  --> (3)
- Example 9: "Elevated BP noted, could be stress-induced."--> (3)
"""
...
print(extracted_notes['LLM_class'].value_counts())
# Save final results

extracted_notes.to_csv(f"/results/P1/A11_hypertension_llama70_21_rag2_{RANDOM_SEED}.csv", index=False)
