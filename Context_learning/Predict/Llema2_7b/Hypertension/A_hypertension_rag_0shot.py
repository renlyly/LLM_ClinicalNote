...
Examples:
- Example 1: "Patient has hypertension history." --> (1) Yes
- Example 2: "Blood pressure normal." --> (2) No
- Example 3: "Unclear if HTN is present." --> (3) Unknown
"""
...
extracted_notes.to_csv(f"/results/P1/A11_hypertension_llama70_11_rag2_{RANDOM_SEED}.csv", index=False)