...
Task: 
Classify the presence of metastasis from patient clinical notes. Respond only with the following numerical codes based on the notes provided:
...
extracted_notes.to_csv(f"/results/P1/p1_results_llama70_22_{RANDOM_SEED}.csv", index=False)